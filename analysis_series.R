...
# Create rows 2 and 4 of the final figure using grid.arrange
...
median_data_random_table <- aggregate(. ~ models, data_random_table, median)
median_data_random_table$cor <- round(median_data_random_table$cor,2)
median_data_random_table$rmse <- round(median_data_random_table$rmse,2)
median_data_random_table$mape <- round(median_data_random_table$mape,2)
median_data_random_table$msa <- round(median_data_random_table$msa,2)
median_data_random_table$sspb <- round(median_data_random_table$sspb,2)
median_data_random_table$sd <- round(median_data_random_table$sd,2)
median_data_random_table$iqr <- round(median_data_random_table$iqr,2)
...
median_data_pref_table <- aggregate(. ~ models, data_pref_table, median)
median_data_pref_table$cor <- round(median_data_pref_table$cor,2)
median_data_pref_table$rmse <- round(median_data_pref_table$rmse,2)
median_data_pref_table$mape <- round(median_data_pref_table$mape,2)
median_data_pref_table$msa <- round(median_data_pref_table$msa,2)
median_data_pref_table$sspb <- round(median_data_pref_table$sspb,2)
median_data_pref_table$sd <- round(median_data_pref_table$sd,2)
median_data_pref_table$iqr <- round(median_data_pref_table$iqr,2)
